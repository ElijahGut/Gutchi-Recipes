...
class NewRecipe extends React.Component<Props, State> {
                ...
                <div>
                    <div>
                        <form onSubmit={this.addRecipe}>
                            ...
                            <select className='formInput' style={{padding: '3px'}} name='mealType' onChange={this.handleMealTypeChange} value={this.state.meal_type}>
                            ...
                            <div className='inputDiv'>
                                <label htmlFor='image'>Photo URL</label><br/>
                                <input className='formInput' name='image' type='text' 
                    ...
                    <button className='styledButton' onClick={() => window.location.reload()}>Back to browse</button>
                </div>
            </Container> 
        )
    }
